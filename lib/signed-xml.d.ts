...
import type { CanonicalizationAlgorithmType, CanonicalizationOrTransformAlgorithmType, CanonicalizationOrTransformationAlgorithm, CanonicalizationOrTransformationAlgorithmProcessOptions, ComputeSignatureOptions, ErrorFirstCallback, GetKeyInfoContentArgs, HashAlgorithm, HashAlgorithmType, ObjectAttributes, Reference, AttachmentReference, SignatureAlgorithm, SignatureAlgorithmType, SignedXmlOptions } from "./types";
...
export declare class SignedXml {
     ...
     * @param type An optional `Type` attribute for the reference.
     */
    addAttachmentReference({ attachment, transforms, digestAlgorithm, uri, digestValue, inclusiveNamespacesPrefixList, isEmptyUri, id, type, }: Partial<Reference> & Pick<AttachmentReference, "attachment">): void;
    /**
     ...
     */
    getAttachmentReferences(): AttachmentReference[];
